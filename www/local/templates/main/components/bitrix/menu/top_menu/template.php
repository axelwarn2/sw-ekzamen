    ...
    <ul class="nav__list">
        ...
        foreach ($arResult as $arItem): ?>
            ...
            <?php if ($arItem["DEPTH_LEVEL"] == 1 && !$arItem["IS_PARENT"] && $arItem["PERMISSION"] > "D"): ?>
                ...
                <a href="<?= $APPLICATION->GetCurPage() === $arItem["LINK"] ? "javascript:;" : $arItem["LINK"] ?>" class="nav__list-link"><?= $arItem["TEXT"] ?></a>
            ...
            <?php else: ?>
                ...
                <?php if ($arItem["IS_PARENT"]): ?>
                    <?php if ($arItem["DEPTH_LEVEL"] == 1): ?>
                        <li class="nav__list-item">
                            <a href="<?= $APPLICATION->GetCurPage() === $arItem["LINK"] ? "javascript:;" : $arItem["LINK"] ?>" class="nav__list-link <?php if ($arItem["SELECTED"]): ?>root-item-selected<?php else: ?>nav__item-toggler<?php endif ?>">
