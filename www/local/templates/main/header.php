                    ...
                    <div class="header__exclamation modal__btn" data-target="#consultation"
                        ...
                        <div class="header__exclamation-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                        d="M12 9V12.75M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944
                                    7.02944 3 12 3C16.9706 3 21 7.02944 21 12ZM12 15.75H12.0075V15.7575H12V15.75Z"
                                        stroke="#8D8D8D" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round"
                                />
                            </svg>
                        </div>
                        <div class="header__exclamation-text">
                            <?= Loc::getMessage("HEADER_ONLINE_CONSULT") ?>
                        </div>
                    </div>

                    <button class="header__btn btn__primary menu nav-menu__toggler"
                            title="<?= Loc::getMessage("HEADER_SITE_MENU") ?>">
                        ...
                        <div class="header__btn-text">
                            <?= Loc::getMessage("HEADER_SITE_MENU") ?>
                        </div>
                    </button>
                </div>
